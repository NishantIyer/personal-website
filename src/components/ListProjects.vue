...
<template>
  <div class="max-w-300 mx-auto">
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <p op75>
        <em>
          Thanks for getting interested in my works! If you want to know more about one, then please feel free to contact me at
          &nbsp;<a
            href="mailito:nishant.iyer62@gmail.com"
            target="_blank"
